...
brew install git
brew install awscli exa fish nmap openssl tree whois 
...
brew cask install 1password6 atom bettertouchtool caffeine docker-edge dropbox firefox istat-menus5 mailspring miniconda2 pycharm-ce slack spotify typora
